...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php $ubah = mysqli_query ($koneksi, "select * from barang_masuk where no ='$ud1'");
...
if (isset($_POST['edt'])) {
	...
	$cek = mysqli_query($koneksi, "select * from barang_masuk where no='$data[0]'"); //cek data yg mau diedit
	
  if (mysqli_num_rows($cek) !=0) {
		$edit = mysqli_query($koneksi, "UPDATE `barang_masuk` set  `jumlah_msk`='$jumlah', `harga_msk`='$harga',`total_harga`='$total1' where `no`='$ud1'") 
		or die (mysqli_error());
                        ...
                        <form action="" method="post" class="popup-form col-lg-4">
							...
							<label>Tanggal Barang Masuk</label>
                             ...
                             <button type="submit" class="btn btn-primary" name="edt"><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
								...
								<a href="barang_masuk.php" button type="reset" class="btn btn-default"> <span class="glyphicon glyphicon-triangle-right"></span> Kembali</a>
