...
<div class="container-fluid">
                ...
                <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">Data OVK Terpakai <small>Total OVK Pakai</small><small>( <?php echo IndonesiaTgl(date('Y-m-d'));?> )</small></h1>
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#reload_data").load('get_lapovk1.php?id=<?php echo $ud1;?>');
