...
?>
                                ...
                                <input type="password" id="passw" class="form-control form-white"  name="pass" placeholder="Enter text">

								<label>Nomor Induk Kepegawaian</label>
                                <input  class="form-control form-white"  name="kdpt" placeholder="Enter text">								
