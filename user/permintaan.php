                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Master Data <small>Permintaan Barang</small><small>( <?php echo IndonesiaTgl(date('Y-m-d'));?> )</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-desktop"></i> Semua Data Permintaan Barang
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="form-group">
  <span class="glyphicon glyphicon-list" aria-hidden="true"></span><a href="persed_barang.php"  class="btn btn-blue">Pesediaan Barang</a>
  </div>
