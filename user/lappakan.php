...
<th class="active" ><span class='glyphicon glyphicon-list'></span>  Jumlah Pakan</th></ol>
...
<div class="table-responsive">
 ...
 <form class="form-inline" method="get">
  ...
  <br></br>  <br></br>
    ...
    if ($anu) {
	 ...
	 if (mysqli_num_rows($sql) == 0) {
        ...
        <tr align="center" bgcolor="#CCCCCC">
          ...
          <td align="center"><a href="cetakpakanper.php?id='.$data[7].'" target="_blank" class="btn-primary btn-sm"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a> 
          </td>
        </tr>';
        }
      }
	...
	<div class="table-responsive">
 <a href="cetakpakanall.php" target="_blank" class="btn btn-primary" name="simpan"><span class="glyphicon glyphicon-print"></span> Cetak Data</button><a/>
</div>
</div> 
