...
<script type="text/javascript">
		...
		window.open('cetakmatiall.php', 'page','toolbar=0, scrollbars=1,location=0,statusbar=0,menubar=0,risizable=0,width=750,height=700,left=50,top=50,titlebar=NO')
		}
	</script>
  ...
  <tr>
   ...
   <tr>
	...
	<tr>
	<td valign="top" align="CENTER"><font size="3px"><b>Laporan Total Ayam Mati</b></font></td>
	</tr>
	</table>
    ...
    $sql= mysqli_query ($koneksi, "SELECT `tbpenyerahanbibit` .* , `tbpemeliharaanharian`.`IDProduksi`,SUM(`tbpemeliharaanharian`.`Mati`) as `total` FROM `tbpenyerahanbibit` LEFT JOIN `tbpemeliharaanharian` ON `tbpenyerahanbibit`.`IDProduksi` = `tbpemeliharaanharian`.`IDProduksi` GROUP by `tbpenyerahanbibit`.`Periode` desc");
	 if (mysqli_num_rows($sql) == 0) {
        ...
        <tr align="center" bgcolor="#CCCCCC">
          <td>'.$no.'</td>  
          <td>'.$data[7].'</td>
		  <td align="center">'.$data[11].' Ekor</td>
...
<br><br/><br><br/><br><br/>
 ...
 <tr >
  <td colspan="3">  <p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Staff PPL</p></td>
  </tr>
  <tr>  </tr><tr>  </tr><tr>
<tr>
