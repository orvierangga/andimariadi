...
<script type="text/javascript">
		...
		window.open('cetakovkall.php', 'page','toolbar=0, scrollbars=1,location=0,statusbar=0,menubar=0,risizable=0,width=750,height=700,left=50,top=50,titlebar=NO')
		}
	</script>
  ...
  <tr>
   ...
   <tr>
	...
	<tr>
	<td valign="top" align="CENTER"><font size="3px"><b>Laporan Total Pemakaian OVK (Obat Vaksin Kimia)</b></font></td>
	</tr>
	</table>
    ...
    <?php
	 ...
	 if (mysqli_num_rows($sql) == 0) {
        ...
        <tr align="center" bgcolor="#CCCCCC">
          <td>'.$no.'</td>  
          <td>'.$data[7].'</td>
		  <td align="center">'.$data[11].' Pcs/Bks</td>
