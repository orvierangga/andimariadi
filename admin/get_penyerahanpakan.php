...
include '../conn.php';?>
    ...
    <?php
      ...
      if (mysqli_num_rows($sql) == 0) {
		...
		<td><a href="cetakpenpakanper.php?id='.$data[0].'"  target="_blank" class="btn-primary btn-sm"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a> 
        
		<a href="editpenyerahanpakan.php?id='.$data[0].'"  class="btn-primary btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> 
