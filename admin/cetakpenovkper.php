...
<script type="text/javascript">
		...
		window.open('cetakpenovkper.php', 'page','toolbar=0, scrollbars=1,location=0,statusbar=0,menubar=0,risizable=0,width=750,height=700,left=50,top=50,titlebar=NO')
		}
	</script>
...
<?php 
//anu koding seleksi
$data1 = mysqli_query($koneksi, "SELECT * from tbpenyerahanovk where IDPenyerahanOVK ='$ud1' ");
...
?>
  ...
  <tr>
   ...
   <tr>
	...
	<tr>
	<td valign="top" align="CENTER"><font size="3px"><b>Lembar Penyerahan OVK</b></font></td>
	</tr>
...
<ol class="breadcrumb form-control"><li class="active ">
<i class="fa fa-plus-square"></i> ID Produksi : &nbsp;&nbsp;<?php echo $row[1];?></li>
   </ol> 
<ol class="breadcrumb form-control"><li class="active ">
