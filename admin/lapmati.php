...
<div class="container-fluid">
                ...
                <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">Data Ayam Mati <small>Total Ayam Mati</small><small>( <?php echo IndonesiaTgl(date('Y-m-d'));?> )</small></h1>
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#reload_data").load('get_lapmati.php?id=<?php echo $ud1;?>');
