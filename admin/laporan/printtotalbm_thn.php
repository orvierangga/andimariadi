...
$sql=mysql_query("SELECT `tanggal_msk`,`kd_barang`,`jumlah_msk`,`harga_msk`,`total_harga` from `barang_masuk` where year(`tanggal_msk`) ORDER BY `tanggal_msk`");
$data = array();
...
$judul = "TOTAL BIAYA BARANG MASUK PERTAHUN";
$header = array(

array("label"=>"Tanggal Masuk", "length"=>45, "align"=>"C"),
array("label"=>"Kode Barang", "length"=>35, "align"=>"C"),
array("label"=>"Jumlah Masuk", "length"=>30, "align"=>"C"),
array("label"=>"Harga Satuan", "length"=>35, "align"=>"C"),
array("label"=>"Total Biaya Perbarang", "length"=>45, "align"=>"C"),
);
