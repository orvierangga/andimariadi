...
$sql=mysql_query("SELECT * FROM data_barang ORDER BY kd_barang");
$data = array();
...
$judul = "DAFTAR TARGET PERSEDIAAN BARANG";
$header = array(

array("label"=>"Kode Barang", "length"=>25, "align"=>"C"),
array("label"=>"Nama Barang", "length"=>45, "align"=>"C"),
array("label"=>"Jenis Barang", "length"=>50, "align"=>"C"),
array("label"=>"Keterangan", "length"=>70, "align"=>"C"),
