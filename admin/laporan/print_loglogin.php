...
$sql=mysql_query("SELECT `tgl_msk`,`status_log`,`username`,`jam_msk`,`jam_klr` FROM `log_login` ");
$data = array();
...
$judul = "LOG DATA AKSES PENGGUNA";
$header = array(

array("label"=>"Tanggal Akses", "length"=>35, "align"=>"C"),
array("label"=>"Status", "length"=>30, "align"=>"C"),
array("label"=>"Nama Petugas", "length"=>45, "align"=>"C"),
array("label"=>"Waktu Masuk/Login", "length"=>40, "align"=>"C"),
array("label"=>"Waktu Keluar/Log Out", "length"=>40, "align"=>"C"),
);
