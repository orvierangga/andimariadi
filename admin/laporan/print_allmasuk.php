...
$sql=mysql_query("SELECT `barang_masuk` .`kd_barang`,`data_barang`.`nama_brg`,`data_barang`.`jenis_brg`,`data_barang`.`ket`,`barang_masuk` .`jumlah_msk`,`barang_masuk`.`harga_msk`,`barang_masuk` .`tanggal_msk`,`barang_masuk` .`total_harga` FROM `barang_masuk` LEFT JOIN `data_barang` ON `barang_masuk`.`kd_barang` = `data_barang`.`kd_barang` order by `barang_masuk`.`tanggal_msk` desc ");
...
$judul = "DATA SEMUA BARANG MASUK";
$header = array(
array("label"=>"Kode", "length"=>10, "valign"=>"C"),
array("label"=>"Nama Barang", "length"=>25, "valign"=>"C"),
array("label"=>"Jenis Barang", "length"=>38, "valign"=>"C"),

array("label"=>"Keterangan" , "length"=>45, "valign"=>"C"),
array("label"=>"Jumlah", "length"=>15, "valign"=>"C"),
array("label"=>"Harga Satuan", "length"=>20, "valign"=>"CENTER "),
array("label"=>"Tanggal", "length"=>20, "valign"=>"C"),
array("label"=>"Total Harga", "length"=>17, "valign"=>"C"),
);
