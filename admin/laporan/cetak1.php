...
<?php $ubah = mysqli_query ($koneksi, "select * from permintaan_barang where kd_perm='$ud'");
...
$nama=$_POST['nama'];
$nip=$_POST['nip'];
$sql= mysqli_query ($koneksi,"SELECT * FROM permintaan_barang where kd_perm = '$data[0]' ");
...
<br>
 ...
 <div> <table>
  <tr>
    <td>&nbsp;</td>
    <td height="25" align="center" width="800px" style="font-size: 20px; font-family: arial; "><strong>LAPORAN DAFTAR PERMINTAAN BARANG</strong></td>
  </tr>
</table>
</center>
<p>
</div>
    <h4 style="font-size: 12px; font-family: arial;">Nama Petugas/Status  : <?php echo $data[7]; ?>  </h4>
 	<table style="font-size: 16px; font-family: arial;" class="table table-striped table-hover" width="500px" bgcolor="#f5deb3">
    <tr ><th width="5px"></th>
      <th width="400px" align="left">Tanggal Permintaan</th> <th width="20px" align="left"> : </th>
      ...
      <th width="400px" align="left">Kode Barang</th> <th width="10px" align="left"> : </th>
		...
		<tr><th></th><th></th></tr><!--./spasi-->
		 ...
		 <tr ><th width="5px"></th>
      <th width="400px" align="left">Jumlah Permintaan</th> <th width="10px" align="left"> : </th>
	...
	<tr><th></th><th></th></tr><!--./spasi-->
		 ...
		 <tr ><th width="5px"></th>
      <th width="400px" align="left">Waktu</th> <th width="10px" align="left"> : </th>
        <th width="400px" align="left"> <?php echo $data[4]; ?> </th>
		</tr>
      ...
      <th width="400px" align="left">Keperluan</th> <th width="10px" align="left"> : </th>
		...
		<tr><th></th><th></th></tr><!--./spasi-->
		 ...
		 <tr ><th width="5px"></th>
      <th width="400px" align="left">Status Permintaan</th> <th width="10px" align="left"> : </th>
        <th width="400px" align="left"> <?php echo $data[6]; ?> </th>
		</tr>
    ...
    ?>
	 ...
	 <h5 style="font-size: 12px; font-family: arial;" align="center">Nama Petugas/Status  : <?php echo $data[7]; ?>  </h5>
 	<br>
